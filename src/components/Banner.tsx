...
const Banner = () => {
    ...
    return (
        <div className="relative bg-cover bg-center h-[800px] md:h-[600px]" style={{ backgroundImage: "url('/img-moca.png')" }}>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center">
                <h1 className="text-white text-3xl font-bold mb-6">Vende. Aluga. Conecta.</h1>
                ...
                <div className="hidden md:flex bg-white shadow-md rounded-full overflow-hidden max-w-4xl w-full cursor-pointer">
                    ...
                    <button className="bg-orange-500 text-white w-12 h-12 p-4 mt-1 mr-2 flex items-center justify-center rounded-full hover:bg-orange-600 transition">
            ...
            <div className="md:hidden flex flex-col items-center justify-center h-full">
                <h1 className="text-white text-2xl font-bold">Vende. Aluga. Conecta.</h1>
            </div>
        </div>
    );
};
