...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-50 text-gray-800 mt-24">
            {/* Tabs Section */}
            <div className="md:mx-40 border-b border-gray-200">
            ...
            <div className="bg-[#EDF1F4]">
                <div className="md:mx-40 grid grid-cols-1 md:grid-cols-4 gap-8 px-6 py-8 p-6">
                    {footerLinks.map((section, index) => (
                        <div key={index}>
                            ...
                            {section.title == 'Nossos Aplicativos' &&
                                <div className="flex justify-start md:justify-between mt-4">
                                    <img
                                        src='/app.png'
                                        alt='Apple Store'
                                        className=" object-cover mr-8 md:mr-0"
                                    />
                                    <img
                                        src='/google.png'
                                        alt='Play Store'
            ...
            <div className="bg-orange-500 ">
                <div className="md:mx-40 text-white text-sm py-4 md:py-2 px-6 md:flex md:justify-between items-center">
                    ...
                    <div className="mb-4 mt-8 md:mb-0 md:mt-0 flex justify-center">
                        <img
                            src='/SocialMedia.png'
                            alt='NetImoveis'
                            className=" object-cover"
